...
def transcribe_with_gemini(audio_bytes, language, api_key, model):
    ...
    if wants_roman_urdu(language):
        instructions += (
            ...
            "Standardize Roman Urdu spellings to be clean, readable, and consistent. Follow these spelling standardizations:\n"
            "- 'mujhe' (not 'mjhe' or 'mujhy')\n"
            "- 'karna' (not 'krna')\n"
            "- 'kar' (not 'kr')\n"
            "- 'kya' (not 'kia')\n"
            "- 'hain' (not 'hein')\n"
            ...
            "- 'yaar' (not 'yr')\n"
            "- 'chahiye' (not 'chahye')\n"
            "- 'raha' / 'rahi' / 'rahe' (not 'rha' / 'rhi' / 'rhe')\n"
            "- 'nahi' (not 'nhi')\n"
            "- 'lekin' (not 'lkn')\n"
            "- 'par' or 'pe' (not 'pr' or 'pa')\n"
            "- 'liye' (not 'lye')\n"
            "- 'kuch' (not 'kch')\n"
            "- 'sab' (not 'sb')\n"
            "- 'phir' (not 'phr')\n"
            ...
            "- 'aise' (not 'ese')\n"
            "- 'baad' (not 'bad')\n"
            "- 'pehle' (not 'pehlay' or 'pehly')\n"
            "- 'zyada' (not 'ziada' or 'ziyada')\n"
            "- 'bohat' (not 'boht' or 'bht')\n"
            "- 'samajh' (not 'samjh' or 'smjh')\n"
            "- 'SubSync' (not 'sub sync' or 'subsync')\n"
            "Keep technical brand names like Vercel, Flask, Git, Python, Groq, Gemini capitalized correctly."
        )
